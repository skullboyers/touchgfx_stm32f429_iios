; Listing generated by Microsoft (R) Optimizing Compiler Version 19.25.28614.0 
	...
	TITLE	E:\skull\TouchGFX\Projects\iioss\stm32f429_touchgfx_iios\Src\generated\fonts\src\Table_verdana_20_4bpp.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__22EA3E90_Table_verdana_20_4bpp@cpp DB 01H
msvcjmc	ENDS
CONST	SEGMENT
...
_BSS	SEGMENT
?verdana_20_4bpp@?1??getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4V23@A DB 024H DUP (?) ; `getFont_verdana_20_4bpp'::`2'::verdana_20_4bpp
?$TSS0@?1??getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA DD 01H DUP (?) ; TSS0<`template-parameter-2',etFont_verdana_20_4bpp,touchgfx::AAAVGeneratedFont,void,int, ?? &>
_BSS	ENDS
;	COMDAT rtc$TMZ
rtc$TMZ	SEGMENT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ$0
__ehfuncinfo$?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
text$yd	SEGMENT
??__Fverdana_20_4bpp@?1??getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ PROC ; `getFont_verdana_20_4bpp'::`2'::`dynamic atexit destructor for 'verdana_20_4bpp'', COMDAT
	push	ebp
	mov	ebp, esp
	...
	pop	ebp
	ret	0
??__Fverdana_20_4bpp@?1??getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ ENDP ; `getFont_verdana_20_4bpp'::`2'::`dynamic atexit destructor for 'verdana_20_4bpp''
text$yd	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
_TEXT	SEGMENT
__$EHRec$ = -12						; size = 12
?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ PROC ; getFont_verdana_20_4bpp, COMDAT
; File E:\skull\TouchGFX\Projects\iioss\stm32f429_touchgfx_iios\Src\generated\fonts\src\Table_verdana_20_4bpp.cpp
; Line 41
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
	...
	mov	ecx, OFFSET __22EA3E90_Table_verdana_20_4bpp@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 42
	mov	eax, DWORD PTR __tls_index
	mov	ecx, DWORD PTR fs:__tls_array
	mov	edx, DWORD PTR [ecx+eax*4]
	mov	eax, DWORD PTR ?$TSS0@?1??getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA
	cmp	eax, DWORD PTR __Init_thread_epoch[edx]
	jle	SHORT $LN2@getFont_ve
	push	OFFSET ?$TSS0@?1??getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA
	call	__Init_thread_header
	add	esp, 4
	cmp	DWORD PTR ?$TSS0@?1??getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA, -1
	...
	push	OFFSET ??__Fverdana_20_4bpp@?1??getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ ; `getFont_verdana_20_4bpp'::`2'::`dynamic atexit destructor for 'verdana_20_4bpp''
	call	_atexit
	add	esp, 4
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ$0:
	push	OFFSET ?$TSS0@?1??getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA
	call	__Init_thread_abort
	pop	ecx
	ret	0
__ehhandler$?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-208]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?getFont_verdana_20_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ ENDP ; getFont_verdana_20_4bpp
; Function compile flags: /Odtp /RTCsu /ZI
